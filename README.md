# push_beijingfengtai 教师招聘公告更新立即推送
以北京丰台校招公告为例</br>
...
1、打开首页，配置好server酱，他会在文件内自动生成data的文件夹。后续可以放到mysql里</br>
2、在common.php这里的token=后面内容替换成你设置的密钥</br>
3、在前台index页，配置好server记得配置好程序后，挂宝塔任务，自动访问url就可以，根目录/check.php?token=change_me_123456</br>
